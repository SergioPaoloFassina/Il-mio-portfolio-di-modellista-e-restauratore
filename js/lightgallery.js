...
(function (global, factory) {
    ...
    Plugin.prototype.loadContent = function (index, rec, delay) {
        ...
        var _img;
        var _src;
        var _altRegExp = this.s.altRegExp || function (v) { return v }
        var _poster;
        var _srcset;
        var _sizes;
        var _html;
        ...
        if (!_lgUtils2.default.hasClass(_this.___slide[index], 'lg-loaded')) {
            if (iframe) {
                ...
                _this.___slide[index].insertAdjacentHTML('beforeend', `<div class="lg-img-wrap"><img class="lg-object lg-image" src="${_src}" alt="${_altRegExp(_src)}" /></div>`);
            }
